...
if (!isset($_GET['token'])) {
  if (isset($_SESSION['token'])) {
    location(0, "wx.php?token=" . $_SESSION['token']);
  }
          ...
          <div class="my-info panel panel-default">
            <div class="panel-body">
              ...
              <div class="info">
                ...
                <a href="circle.php" class="setbtn"><img width=20px src="img/circle.jpg"></a>
                <a href="includes/do.php?action=logout"><img width=20px src="img/logout.jpg"></a>
              </div>
            </div>
          </div>
          <button id="addBtn" onClick=" $('.modal-footer').show();$('#addf').modal('show');"
                  class="btn btn-default btn-block">加好友
          </button>
          <p>
          <ul class="list-group">
            ...
            <?php
            foreach ($friend as $f) { ?>
              <li class='friends list-group-item' data-weixin="<?php echo $f['weixin']; ?>"
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form">
          <div class="form-group">
            ...
            <div class="col-xs-8">
              <input type="text" id="weixin" name="weixin" value="<?php echo $user['weixin'] ?>" class="form-control"
                     readonly>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-8">
              <select name="head" class="form-control selectpicker" id="head">
                <?php
                for ($i = 0; $i <= 10; $i++) {
          ...
          <div class="form-group">
            ...
            <div class="col-xs-2">
              <input name="sex" class="control-form" type="radio"
